...
ActiveRecord::Schema.define(version: 20150727045922) do
  ...
  create_table "comments", force: :cascade do |t|
    t.integer  "ramen_id",   limit: 4,     null: false
  ...
  create_table "ramen_shops", force: :cascade do |t|
    t.integer  "ramen_id",      limit: 4
    t.integer  "shop_id",       limit: 4
    t.integer  "chain_shop_id", limit: 4
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
  end

  create_table "ramen_tastes", force: :cascade do |t|
    t.integer  "ramen_id",   limit: 4
